...
namespace ProjectManagement.Infrastructure.Data
{
    public static class ProjectManagementDataInMemory
    {
        ...
        {
            new () {ProjectId=1000,EmployeeNumber=111,HourseWorked=50,AssignmentName="Reports"},
            new () {ProjectId=1000,EmployeeNumber=112,HourseWorked=100,AssignmentName="case study"},
            new () { ProjectId = 1000, EmployeeNumber = 113, HourseWorked = 50,AssignmentName = "FileSystem" },
            new () { ProjectId = 1001, EmployeeNumber = 114, HourseWorked = 150,AssignmentName="Linq" },
            new () { ProjectId = 1001, EmployeeNumber = 112, HourseWorked = 100,AssignmentName = "case study" },
            new () { ProjectId = 1001, EmployeeNumber = 111, HourseWorked = 140,AssignmentName = "Reports" },
            new () { ProjectId = 1002, EmployeeNumber = 113, HourseWorked = 95,AssignmentName = "FileSystem" },
            new () { ProjectId = 1002, EmployeeNumber = 112, HourseWorked = 85,AssignmentName = "case study" },
            new () { ProjectId = 1002, EmployeeNumber = 111, HourseWorked = 78,AssignmentName = "Reports" },
            new () { ProjectId = 1003, EmployeeNumber = 112, HourseWorked = 250,AssignmentName = "case study" },
            new () { ProjectId = 1003, EmployeeNumber = 114, HourseWorked = 125,AssignmentName = "Linq" },
            new () { ProjectId = 1003, EmployeeNumber = 111, HourseWorked = 150,AssignmentName = "Reports" },
            new () { ProjectId = 1004, EmployeeNumber = 115, HourseWorked = 80,AssignmentName = "Collections" },
            new () { ProjectId = 1004, EmployeeNumber = 116, HourseWorked = 70,AssignmentName = "ASP" },
            new () { ProjectId = 1004, EmployeeNumber = 117, HourseWorked = 90,AssignmentName = "Directory" },
            new () { ProjectId = 1004, EmployeeNumber = 118, HourseWorked = 90,AssignmentName = "Testing" },
            new () { ProjectId = 1005, EmployeeNumber = 115, HourseWorked = 50,AssignmentName="Collections" },
            new () { ProjectId = 1005, EmployeeNumber = 116, HourseWorked = 300,AssignmentName="ASP" },
            new () { ProjectId = 1005, EmployeeNumber = 117, HourseWorked = 100,AssignmentName="Directory" },
            new () { ProjectId = 1005, EmployeeNumber = 115, HourseWorked = 140,AssignmentName="Collections" },
            new () { ProjectId = 1006, EmployeeNumber = 116, HourseWorked = 85,AssignmentName="ASP" },
            new () { ProjectId = 1006, EmployeeNumber = 118, HourseWorked = 95,AssignmentName="Testing" },
            new () { ProjectId = 1006, EmployeeNumber = 117, HourseWorked = 78,AssignmentName="Directory" },
            new () { ProjectId = 1006, EmployeeNumber = 116, HourseWorked = 250,AssignmentName="ASP" },
            new () { ProjectId = 1007, EmployeeNumber = 119, HourseWorked = 125,AssignmentName="Typing" },
            new () { ProjectId = 1007, EmployeeNumber = 120, HourseWorked = 150,AssignmentName="Network" },
            new () { ProjectId = 1007, EmployeeNumber = 121, HourseWorked = 80,AssignmentName="Design" },
            new () { ProjectId = 1007, EmployeeNumber = 122, HourseWorked = 140,AssignmentName="Database" },
            new () { ProjectId = 1008, EmployeeNumber = 119, HourseWorked = 85,AssignmentName="Typing" },
            new () { ProjectId = 1008, EmployeeNumber = 120, HourseWorked = 95,AssignmentName="Network" },
            new () { ProjectId = 1008, EmployeeNumber = 121, HourseWorked = 78,AssignmentName="Design" },
            new () { ProjectId = 1009, EmployeeNumber = 119, HourseWorked = 250,AssignmentName="Typing" },
            new () { ProjectId = 1009, EmployeeNumber = 120, HourseWorked = 125,AssignmentName="Network" },
            new () { ProjectId = 1009, EmployeeNumber = 121, HourseWorked = 150,AssignmentName="Design" },
            new () { ProjectId = 1010, EmployeeNumber = 119, HourseWorked = 80,AssignmentName="Typing" },
            new () { ProjectId = 1010, EmployeeNumber = 120, HourseWorked = 60,AssignmentName="Network" },
            new () { ProjectId = 1011, EmployeeNumber = 121, HourseWorked = 80,AssignmentName="Design" }
        };
